    ...
    def generate(
        ...
        **model_kwargs,
        ...
        if is_greedy_gen_mode:
            ...
            print("is contrastive search gen mode!!!")
    ...
    def beam_search(
        ...
        **model_kwargs,
        ...
        while True:
            ...
            # chenhui: modify to accomodate sep positions
            if self.use_original_bart is True:
                outputs = self(
                    **model_inputs,
                    return_dict=True,
                    output_attentions=output_attentions,
                ...
                outputs = self(
                    **model_inputs,
                    ...
                    output_attentions=output_attentions,
                    output_hidden_states=output_hidden_states,
                    sep_positions = model_kwargs['sep_positions'], # chenhui: add this parameter
                )
        ...
        # # chenhui: debug
        # print("bef finalize", len(beam_indices)) # 4 beams 
        # print(len(beam_indices[0])) # here still 121
        ...
        # # chenhui: debug
        # print("after finalize:", len(sequence_outputs["beam_indices"][0]))
