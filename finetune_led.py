...
class ModelArguments:
    ...
    model_name_or_path: str = field(
        default="/mnt/workspace/utils/huggingface_models/LED-large",
...
def main():
    ...
    def preprocess_function(examples):
        ...
        # chenhui: add global attention mask, follow LED recommendation to use only global attention at 1st token
        model_inputs["global_attention_mask"] = len(model_inputs["input_ids"]) * [
            [0 for _ in range(len(model_inputs["input_ids"][0]))]
        ]
        model_inputs["global_attention_mask"][0][0] = 1 # double checked, all sample in the same batch has the global attention at start
